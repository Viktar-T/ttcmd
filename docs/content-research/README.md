...
| [`course-structure-v2.md`](course-structure-v2.md) | **The working proposal.** Learning-by-doing restructure of 2026-08-30: „Teraz ty” after the demo, Warsztat at position 2, old Moduł 2 dissolved into build weeks, stack declared provisionally and ratified with students — plus the lab-preparation lists (Windows / Ubuntu) |
