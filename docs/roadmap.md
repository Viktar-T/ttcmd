...
| Owner        | Viktar                                                                                                                                                            |
| Last revised | 2026-09-15 — **022 closed** (session titles on the progress page); **021 closed** (the progress button on the front door); 2026-09-10 — **020 closed** (the narrower progress table); **016 is now the group progress page**, built and closed; the three unbuilt slices renumbered up by two (search → 017, glossary → 018, discoverability → 019); **Done** brought up to date with 007–016 |
...
**Application** — nineteen slices closed: 001 through 016, and 020 through 022. See **Done** below.
...
| **022-session-titles** | a session on /postep may carry its registered class name, shown before its topics as the session's own number and the title; a title typed with a leading number is refused |
